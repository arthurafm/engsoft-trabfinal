...
export default function Page(){
	...
	if(!cognitoUser || userData?.__typename != "Professor"){
		return <div style={{minHeight: '82vh', color:'#C73700', fontFamily: 'Roboto', fontSize: 80, fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center'}}>Ops, você não é professor!</div>
	}
